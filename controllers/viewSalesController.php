...
$getSalesByUser = $sale->getSalesByUser($userId);

// Validar ejecución correcta del método
if (!$getSalesByUser['success']) {
    $database->closeConnection(); 
    die($getSalesByUser['errorMessage']);
}

// Éxito, cerrar conexión y obtener array de ventas
$database->closeConnection();
$arraySales = $getSalesByUser['salesArray'];

require_once '../views/viewSalesView.php';
?>